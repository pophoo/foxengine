...
def uplaind2(stock,lens=(7,13,30)):
    ...
    md = gand(stock.diff>stock.dea,dgd<11)
...
def b102(stock,covered=60):
    '''
        ...
        08-1004
        评估:总盈亏值=128964,交易次数=615       期望值=1971
                总盈亏率(1/1000)=128964,平均盈亏率(1/1000)=209,盈利交易率(1/1000)=769
                平均持仓时间=40,持仓效率(1/1000000)=5225
                赢利次数=473,赢利总值=144100
                亏损次数=142,亏损总值=15136
                平盘次数=0

        筛选背离后:
            评估:总盈亏值=82515,交易次数=423        期望值=1857
                总盈亏率(1/1000)=82515,平均盈亏率(1/1000)=195,盈利交易率(1/1000)=775
                平均持仓时间=39,持仓效率(1/1000000)=5000
                赢利次数=328,赢利总值=92549
                亏损次数=95,亏损总值=10034
                平盘次数=0
        ...
        05-0710
        评估:总盈亏值=41319,交易次数=312        期望值=1168
                总盈亏率(1/1000)=41319,平均盈亏率(1/1000)=132,盈利交易率(1/1000)=538
                平均持仓时间=28,持仓效率(1/1000000)=4714
                赢利次数=168,赢利总值=57498
                亏损次数=143,亏损总值=16179
...
def b2(stock,covered=60):
    '''
      ...
      快速出击品种，b102的扩展版本，效果上不如b102
        ...
        08-1004
        评估:总盈亏值=104132,交易次数=1003      期望值=919
                总盈亏率(1/1000)=104132,平均盈亏率(1/1000)=103,盈利交易率(1/1000)=559
                平均持仓时间=33,持仓效率(1/1000000)=3121
                赢利次数=561,赢利总值=153603
                亏损次数=439,亏损总值=49471
                平盘次数=3
 
        gfilter = gand(stock.g20<6000)
        评估:总盈亏值=67268,交易次数=398        期望值=1640
                总盈亏率(1/1000)=67268,平均盈亏率(1/1000)=169,盈利交易率(1/1000)=678
                平均持仓时间=39,持仓效率(1/1000000)=4333
                赢利次数=270,赢利总值=80548
                亏损次数=128,亏损总值=13280
                平盘次数=0
