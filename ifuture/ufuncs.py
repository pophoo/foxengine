...
def nhhv(sif,vbreak=30):  #貌似20/30都可以
    ...
    signal = gand(
            ...
            #sif.high > thigh,
            cross(thigh,sif.high)>0,
            rollx(sif.close,3) > thigh * 9933/10000, 
...
def _hs123(sif,vbreak=20):  #30首选;4也是一个选择，与hb123配合时，因为早平仓，可以有更大的收益
    ...
    sll = gmin(sll,opend * 1006/1000,ldmid) #??需要加这个过滤么?
