    ...
    '''
        ...
        结合15分钟走势买入更佳，最好情况是选出时15分钟正在下行，然后上叉时(必须>0.00，而不是0.00,防止夭折情况)买入。
                如果正在上行，等待下一次上叉(时间不能超过3个交易日),或者放过
                      15分钟穿上后往下，然后即刻往上并穿过穿上点，也可买入(但离穿上点不应超过4个周期,而且必须曾经往下，直接上去的不要追)
                      另外，延后不超过4个周期，且买入点小于理论买入点的也可以买入(15分钟仍在向上发展)
       ...
       **可以合理的去掉ST股，因为ST股的快速下跌可能有内在原因,以及在群跌时存在当日或几日跌不透(因5%限制)，而拉长下跌期的情况。
        ...
        多选1时，选择XATR大的，打于8.0最好。g20小的。同时，如果下方有长周期支撑线，则直接在该位置埋伏,不必等15分钟上叉.
