...
if __name__ == "__main__":                   
    import logging
    logging.basicConfig(filename="regression.log",level=logging.DEBUG,format='%(asctime)s %(levelname)s %(message)s')
    ...
    parser.add_option("-o","--only", action="store_true", dest="only",help="只执行指定目录下的测试，不包含子目录. 未指定时遍历所有子目录")    #只当前目录
