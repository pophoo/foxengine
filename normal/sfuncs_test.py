...
class ModuleTest(unittest.TestCase):    #通路测试
    def setUp(self):
        ...
        s = BaseObject(code='SH00TEST',transaction=trans,atr=g,silver=g,g5=g,g20=g,g60=g,g120=g,g250=g,diff=g,dea=g,ma1=g,ma2=g,ma3=g,ma4=g,ma5=g,t5=g,above=g,golden=g,thumb=g,svap_ma_67=(g,vi),vap_ma_67=(g,vi))
        s.ref = s   #指向自己
        s.catalog = {s:g}
        s.c60 = {s:g}
        self.stock = s
