...
def prepare_configs_A1200(seller,pman,dman):    
    ...
    configs.append(config(buyer=fcustom(svama3,fast=165,mid=340,slow=1790))) 	#1125-81-625-24     #@1323-90-625-24   ###1191-87-652-23
    ...
    configs.append(config(buyer=fcustom(svama3,fast=150,mid=350,slow=1990))) 	#1450-116-583-24
