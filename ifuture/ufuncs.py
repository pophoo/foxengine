...
hbreak_nhhz = BXFuncA(fstate=gofilter,fsignal=nhhz,fwave=nx2500X,ffilter=mfilter)  ##主要时段
...
shbreak_mll2z = SXFuncA(fstate=sdown,fsignal=mll2z,fwave=nx2000X,ffilter=mfilter2)    #优于nll
